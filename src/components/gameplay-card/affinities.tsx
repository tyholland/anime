  ...
  return (
    <Styles.GameplayCardContainer>
      ...
      <Styles.GameplayCardAffinity>
        ...
        Arcane,{' '}
        <GlobalStyles.GlobalCircle className="darkness"></GlobalStyles.GlobalCircle>{' '}
        Darkness,{' '}
        ...
        Electric,{' '}
        <GlobalStyles.GlobalCircle className="noAffinity"></GlobalStyles.GlobalCircle>{' '}
        No Affinity
      </Styles.GameplayCardAffinity>
      <Styles.GameplayCardAffinity>
        <strong>Affinities Combos</strong>:{' '}
        <GlobalStyles.GlobalCircle className="wind"></GlobalStyles.GlobalCircle>{' '}
        &{' '}
        <GlobalStyles.GlobalCircle className="water"></GlobalStyles.GlobalCircle>
        ,{' '}
      ...
      <Styles.GameplayCardWrapper>
        <div>
          ...
          <Styles.GameplayCardSection className="indent">
            <Styles.GameplayCardTitle className="bold">
              Weeks 1 - 9
            </Styles.GameplayCardTitle>
          </Styles.GameplayCardSection>
        </div>
        <div>
          <Styles.GameplayCardHeader>
