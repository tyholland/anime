...
const AdminDashboard = () => {
  ...
  const [playerChange, setPlayerChange] = useState<string | null>(null);
  ...
  const [editPowerLevel, setEditPowerLevel] = useState<boolean>(false);
  const [editFire, setEditFire] = useState<boolean>(false);
  const [editWater, setEditWater] = useState<boolean>(false);
  const [editWind, setEditWind] = useState<boolean>(false);
  const [editEarth, setEditEarth] = useState<boolean>(false);
  const [editArcane, setEditArcane] = useState<boolean>(false);
  const [editElectric, setEditElectric] = useState<boolean>(false);
  const [editCelestial, setEditCelestial] = useState<boolean>(false);
  const [editDarkness, setEditDarkness] = useState<boolean>(false);
  const [editIce, setEditIce] = useState<boolean>(false);
  const [editNoAffinity, setEditNoAffinity] = useState<boolean>(false);
  const [editWeakness, setEditWeakness] = useState<boolean>(false);
  const [editImage, setEditImage] = useState<boolean>(false);
  const [editStatus, setEditStatus] = useState<boolean>(false);
  const [editCost, setEditCost] = useState<boolean>(false);
  const [editByeWeek, setEditByeWeek] = useState<boolean>(false);
  ...
  const handlePlayerUpdate = (player: Record<string, any>) => {
    setUpdatePlayer(true);
    setPlayerInfo(player.all);
  };

  const handleNewVal = (val: string) => {
    setPlayerChange(val);
  };

  const handlePlayerSave = async (attr: string) => {
    const payload = {
      ...playerInfo,
    };
